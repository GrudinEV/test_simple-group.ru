...
public class ServiceImpl implements Service{
    ...
    public ServiceImpl(DataReader dataReader, LogWriter logWriter,
                       AddedDataFromJsonToBd addedDataFromJsonToBd, WellParameterRepository wellParameterRepository) {
        this.dataReader = dataReader;
        this.logWriter = logWriter;
        this.addedDataFromJsonToBd = addedDataFromJsonToBd;
        this.wellParameterRepository = wellParameterRepository;
        addedDataFromJsonToBd();
    }

    private void addedDataFromJsonToBd() {
        System.out.println("Параметры прочитаны!!!");
    ...
    public void createUniqueParams() {
        System.out.println("In createUniqueParams going!!!!!!");
